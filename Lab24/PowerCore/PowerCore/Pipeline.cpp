...
void PowerCore::BuildRootSignature()
{
...
void PowerCore::BuildPipelineState()
{
    // --------------------
    // --- Input Layout ---
    // --------------------
    ...
    for (UINT i = 0; i < D3D12_SIMULTANEOUS_RENDER_TARGET_COUNT; ++i)
        blender.RenderTarget[i] = blendDesc;
    ...
    pso.RasterizerState = rasterizer;
    pso.DepthStencilState = depthStencil;
    graphics->Device()->CreateGraphicsPipelineState(&pso, IID_PPV_ARGS(&pipelineCullNone));
