...
{ 
    ...
    color += Directional(Lights[0], pIn.Color, normal, toEye, pIn.TexC);
    color += SpotLight(Lights[1], pIn.PosW.xyz, pIn.Color, normal, toEye, pIn.TexC);
